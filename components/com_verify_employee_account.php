...
$sql = "SELECT * FROM tbl_user as usr, tbl_employee as emp WHERE usr.id = emp.user_id AND usr.verification_code = '" . $verifyCode . "'";
...
$result = mysql_query($sql);
	...
	//NEW PASS FORMAT BY MKT
	$userN = explode('_',$row["emp_id_number"]);
	...
	$contents .= "Password:" .'mint'.$userN[1]. "\n";		
	$contents .= "\n--------------------------------------------------------\n\n\n";	
...
$content_template = 'components/block/blk_com_verify_employee_account.php';
?>