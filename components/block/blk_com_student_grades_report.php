...
$(function(){
	...
	$('.profile').click(function(){
		...
		$('#dialog').load('viewer/view_com_student_grades_report.php?id='+param, null);
		$('#dialog').dialog('open');
		return false;
	});
...
$(document).ready(function(){  
	...
	window.open('ajax_components/print_grade_info.php?print='+con);
	}else{
		alert('Search First');
			updateList();
			return false;
...
function updateList(pageNum)
{
	...
	$('#box_container').load('ajax_components/ajax_com_student_grades_report.php?list_rows=10' + param, null);
}
...
<li id="print" <?=$view=='print'?'class="active"':''?>><a href="#" title="Print"><span>Print</span></a></li>
</ul>
