...
$(function(){
	...
	$('.profile').click(function(){
		...
		$('#dialog').load('viewer/view_com_student_profile_report.php?id='+param, null);
		$('#dialog').dialog('open');
		return false;
	});
...
$(document).ready(function(){  
	...
	window.open('ajax_components/print_stud_info.php?print='+con);
	}else{
		alert('Search First');
			updateList();
			return false;
...
function updateList(pageNum)
{
	...
	$('#box_container').load('ajax_components/ajax_com_student_profile_report.php?list_rows=10' + param, null);
}
