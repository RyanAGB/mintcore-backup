...
function updateList(pageNum)
{
	...
	$('#box_container').load('ajax_components/ajax_com_date_enrollment.php?param=1' + param, null);
}
...
?>
	<div class="formview">
        ...
        <fieldset>
           <legend><strong>Enrollment Date Information</strong></legend>
            ...
            <span >
                <select name="e_month" id="e_month" class="txt_100 {required:true}" title="End Date Month field is required">
                    <option value=""></option>
                    <?=generateMonth($e_month)?>
                </select>
                <select name="e_day" id="e_day" class="txt_50 {required:true}" title="End Date Day field is required">
                    <option value="" selected="selected"></option>
                    <?=generateDay($e_day)?>                                                                        
                </select>
                <select name="e_year" id="e_year" class="txt_70 {required:true}" title="End Date Year field is required">
                    <option value="" selected="selected"></option>
                    <?=generateYearForSchoolYear($e_year)?>                                                    
                </select>&nbsp;<a href="noJs.html" id="date-pick3"><img src="images/425irjds.gif" border="0" /></a>
            </span><br class="hid" />
            ...
            <span > <select name="school_year_id" id="school_year_id" class="txt_150 {required:true}" title="School Year field is required">
                  ...
                  <?=generateSchoolYr($school_year_id)?>                                                    
                </select>
            </span><br class="hid" />
            ...
            <span > <select name="term_id" id="term_id" class="txt_150 {required:true}" title="School Term field is required">
                  <option value="" selected="selected">Select</option>
                  <?=generateSchoolTermsBYSY($school_year_id,$term_id)?>                                                    
                </select>                
            </span><br class="hid" />
            <label>Reservation Days:</label>
            <span ><input class="txt_100 {required:true}" title="Reservation Days field is required" name="reserve_days" type="text" value="<?=$reserve_days?>" id="reserve_days" />
            </span><br class="hid" />
            
            <label>Dropping/Adding End Date :</label>
            <span >
                <select name="d_month" id="d_month" class="txt_100 {required:true}" title="Start Date Month field is required">
                    <option value="" selected="selected"></option>
                    <?=generateMonth($d_month)?>
                </select>
                <select name="d_day" id="d_day" class="txt_50 {required:true}" title=" Start Date Day field is required">
                    <option value="" selected="selected"></option>
                    <?=generateDay($d_day)?>                                                                        
                </select>
                <select name="d_year" id="d_year" class="txt_70 {required:true}" title="Start Date Year field is required">
                    <option value="" selected="selected"></option>
                    <?=generateYearForSchoolYear($d_year)?>                                                    
                </select>
            </span><br class="hid" />
