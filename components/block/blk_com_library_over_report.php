...
<?php
		...
		$sql = "SELECT * FROM tbl_report_fields WHERE category = 'L' AND publish ='Y' ORDER BY value_type";						
...
function updateList(pageNum)
{
	...
	$('#box_container').load('ajax_components/ajax_com_library_over_report.php' + param, null);
}
      ...
      <tr>
        <td width="50%" valign="top">
			<table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>Field Name</td>
                <td style="padding-left:10px; height:30px;"><select name="filter_fieldname" id="filter_fieldname" class="txt_200">
                  <option value="" selected="selected">Select field name</option>
                  <?=generateLibraryOverdueReportFields($filter_fieldname)?>
                </select></td>
              </tr>
              <tr>
                <td>Filter Way</td>
