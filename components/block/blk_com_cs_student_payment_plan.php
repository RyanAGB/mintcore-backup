...
function updateList(pageNum)
{
	...
	clearTabs();
	$('#payment').addClass('active');
	$('#box_container').load('ajax_components/ajax_com_cs_student_payment_plan_form.php?param=1' + param, null);
	<?php
	}
	else
	{
	?>
	$('#box_container').load('ajax_components/ajax_com_cs_student_payment_plan.php?param=1' + param, null);
	<?php
	}
	?>
}
...
function schedList(pageNum)
{
	...
	$('#box_container').html(loading);
	$('#box_container').load('ajax_components/ajax_com_cs_student_payment_plan_form.php?list_rows=10' + param, null);
}
