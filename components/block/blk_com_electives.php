...
$(function(){
	...
	$('#dialog_sub').click(function(){
		...
		$('#dialog').load('lookup/lookup_com_all_subject.php?comp='+param, null);
		$('#dialog').dialog('open');
		return false;
	});
...
function updateList(pageNum)
{
	...
	$('#box_container').load('ajax_components/ajax_com_electives.php?param=1' + param, null);
}
...
?>
	<div class="formview">
        ...
        <fieldset>
           <legend><strong>Elective Information</strong></legend>
            ...
            <input class="txt_250 {required:true}" title="Subject Name field is required" name="subject_name_display" type="text" value="<?=$subject_name_display?>" id="subject_name_display" readonly="readonly" />
            </div>
