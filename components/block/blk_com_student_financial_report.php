...
$(function(){
	...
	$('.profile').click(function(){
		...
		$('#dialog').load('viewer/view_com_student_financial_report.php?id='+param, null);
		$('#dialog').dialog('open');
		return false;
	});
...
$(document).ready(function(){  
	...
	window.open('ajax_components/print_financial_info.php?print='+con);
	}else{
		alert('Search First');
			updateList();
			return false;
...
function updateList(pageNum)
{
	...
	$('#box_container').load('ajax_components/ajax_com_student_financial_report.php?list_rows=10' + param, null);
}

function updatePage(pageNum,pageRow)
{
//alert(pageRow+pageNum);
	$('#view').val('edit');
	$('#pagenum').val(pageNum);
...
<table class="listview"> 
	<tr>
              <th class="col_150"><a href="#" class="sortBy" returnFilter="student_number">Student Number</a></th>
              <th class="col_450"><a href="#" class="sortBy" returnFilter="firstname">Full Name</a></th>
              <th class="col_450"><a href="#" class="sortBy" returnFilter="course_name">Course</a></th>
