...
function updateList(pageNum)
{
	...
	if($('#filterdept').val() != '' && $('#filterdept').val() != undefined )
	{
		param = param + '&filterdept=' + $('#filterdept').val();
	}
	if($('#filter_schoolterm').val() != '' )
	{
		param = param + '&filter_schoolterm=' + $('#filter_schoolterm').val();
	...
	$('#box_container').load('ajax_components/ajax_com_professor_schedule.php' + param, null);
}
