...
function updateList(pageNum)
{
	...
	$('#box_container').html(loading);
	$('#box_container').load('ajax_components/ajax_com_st_pending_payment.php?list_rows=10' + param, null);
}
...
function schedList(pageNum)
{
	...
	$('#box_container').html(loading);
	$('#box_container').load('ajax_components/ajax_com_st_pending_payment_history.php?list_rows=10' + param, null);
}
