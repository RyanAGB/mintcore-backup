...
<table class="primary_index">
  ...
  <tr class="<?=($x%2==0)?"":"highlight";?>">
    ...
    <td nowrap="true">
      ...
      ?>
      <?php echo $loc->getText("mbrsearchCardNumber");?> &nbsp;<?php echo H($mbr->getBarcodeNmbr());?>&nbsp;
      <?php echo $loc->getText("mbrsearchClassification");?> &nbsp; <?php echo H($mbrClassifyDm[$mbr->getClassification()]);?>
    </td>
  </tr>
