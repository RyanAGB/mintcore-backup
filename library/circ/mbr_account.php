 ...
 */
  ...
  $dmQ = new DmQuery();
  $dmQ->connect();
  $mbrClassifyDm = $dmQ->getAssoc("ob_transaction_type_dm");
  $dmQ->close();
...
<table class="primary_index">
  ...
  <tr>
    ...
    <td valign="top" class="primary">
      <?php printSelect("transactionTypeCd","ob_transaction_type_dm",$postVars); ?>
    </td>
  </tr>
  <tr>
...
<?php
    ...
    $bal = 0;
    ?>
    <tr><td class="primary" colspan="4"><?php echo $loc->getText("mbrAccountOpenBal"); ?></td><td class="primary"><?php echo 'Php '.H(number_format($bal,2));?></td></tr>
...
?>
  <tr>
    ...
    <td class="primary" valign="top" >
      <?php echo 'Php '.H(abs(number_format($trans->getAmount(),2)));?>
    </td>
    <td class="primary" valign="top" >
      <?php echo 'Php '.H(abs(number_format($bal,2)));?>
    </td>
  </tr>
<?php
$total += abs($trans->getAmount());
...
?>
<tr>
  <td class="primary" valign="top" style="text-align:right" colspan="3">Total</td>
  <td class="primary" valign="top" style="text-align:right" ><?=$total?></td>
  <td class="primary" valign="top" style="text-align:right" ><?='Php '.H(abs(number_format($bal,2)))?></td>
  </tr>
</table>
