...
." b.bibid,null,  null,     b.barcode_nmbr,ifnull(bs.status_cd,'in'),ifnull(bs.status_begin_dt,b.create_dt),bs.due_back_dt,bs.mbrid from "
  ...
  function _upgrade040_e($prfx, $tmpPrfx) {
    ...
    $this->exec("update ".$prfx."ob_mbr_classify_dm set code='1' where code='a' ");
    $this->exec("update ".$prfx."ob_mbr_classify_dm set code='2' where code='j' ");
    $this->exec('alter table '.$prfx.'ob_mbr_classify_dm '
    ...
    $this->exec('insert '.$prfx.'member_fields '
                ...
                . "from ob_member where school_grade is not null "
                . "and school_grade <> '' ");
    $this->exec('insert '.$prfx.'member_fields '
