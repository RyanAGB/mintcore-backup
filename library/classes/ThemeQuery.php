...
class ThemeQuery extends Query {
  ...
  function execSelect($themeid="") {
    if ($themeid == "") {
      $sql = "select * from ob_theme order by theme_name";
    } else {
      $sql = $this->mkSQL("select * from ob_theme where themeid=%N "
  ...
  function insert($theme) {
    $sql = $this->mkSQL("insert into ob_theme "
  ...
  function update($theme) {
    $sql = $this->mkSQL("update ob_theme set theme_name=%Q, "
  ...
  function delete($themeid) {
    $sql = $this->mkSQL("delete from ob_theme where themeid=%N ", $themeid);
