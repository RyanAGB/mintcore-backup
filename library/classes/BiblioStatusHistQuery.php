...
class BiblioStatusHistQuery extends Query {
  ...
  function queryByBibid($bibid) {
    ...
    $sql = $this->mkSQL("select ob_biblio_status_hist.*, "
                        . " ob_biblio.title, ob_biblio.author, "
                        . " ob_biblio_copy.barcode_nmbr biblio_barcode_nmbr, "
                        . " ob_member.last_name, ob_member.first_name, "
                        . " ob_member.barcode_nmbr mbr_barcode_nmbr "
                        . "from ob_biblio_status_hist, ob_biblio, "
                        . " ob_biblio_copy, ob_member "
                        . "where ob_biblio_status_hist.bibid = ob_biblio.bibid "
                        . " and ob_biblio_status_hist.bibid = ob_biblio_copy.bibid "
                        . " and ob_biblio_status_hist.copyid = ob_biblio_copy.copyid "
                        . " and ob_biblio_status_hist.student_id = ob_member.student_id "
  ...
  function queryByMbrid($mbrid) {
    ...
    $sql = $this->mkSQL("select ob_biblio_status_hist.*, "
                        ...
                        . " stud.lib_card_number mbr_barcode_nmbr "
                        . "from ob_biblio_status_hist, ob_biblio, "
                        . " ob_biblio_copy, tbl_student stud "
                        . "where ob_biblio_status_hist.bibid = ob_biblio.bibid "
                        . " and ob_biblio_status_hist.bibid = ob_biblio_copy.bibid "
                        . " and ob_biblio_status_hist.copyid = ob_biblio_copy.copyid "
                        . " and ob_biblio_status_hist.student_id = stud.id "
                        . " and ob_biblio_status_hist.student_id = %N "
  ...
  function insert($hist) {
    $sql = $this->mkSQL("insert into ob_biblio_status_hist values "
                        . "(%N, %N, %Q, sysdate(), ",
  ...
  function deleteByBibid($bibid,$copyid) {
    $sql = $this->mkSQL("delete from ob_biblio_status_hist "
  ...
  function deleteByMbrid($mbrid) {
    $sql = $this->mkSQL("delete from ob_biblio_status_hist where student_id = %N", $mbrid);
  ...
  function _purgeHistory($mbrid) {
    ...
    $sql = $this->mkSQL("delete from ob_biblio_status_hist where student_id = %N"
