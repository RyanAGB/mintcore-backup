...
class BiblioFieldQuery extends Query {
  ...
  function doQuery($bibid,$fieldid) {
    ...
    $sql = $this->mkSQL("select ob_biblio_field.* from ob_biblio_field "
                        . "where ob_biblio_field.bibid = %N "
                        . "and ob_biblio_field.fieldid = %N ", $bibid, $fieldid);
  ...
  function insert($field) {
    ...
    $sql = $this->mkSQL("insert into ob_biblio_field values "
                        . "(%N, null, %N, %Q, %Q, %Q, %Q) ",
  ...
  function update($field) {
    ...
    $sql = $this->mkSQL("update ob_biblio_field set tag=%N, "
