...
<?php
	...
	$row = mysql_fetch_array($query);
	 ...
	 $sqlfee = "SELECT * FROM tbl_school_fee WHERE publish =  'Y' AND term_id=" .CURRENT_TERM_ID;         
...
<td style='font-weight:bolder; font-size:12px;' colspan="2" align="right"><a target="_blank" href="ajax_components/print_financial_info.php?id=<?=$id?>" >PRINT THIS PAGE</a></td></tr>
</table>
        ...
        <tr>
            <td width="50%" valign="top">
                <table class="classic_withoutWidth" width="100%">
                	<tr>
            			<th colspan="2">ASSESSMENT OF FEES</th>
            		</tr>      
                    <tr>
                        <th class="col1_150">Fee</th>   
                        <th class="col1_50">Total</th>                         
                    </tr>
                    <?php
                    $sub_total = 0;
