...
<table border="0" cellspacing="10" cellpadding="0">
    ...
    <td width="300">
        ...
        <table width=100% >
            ...
            <tr>
                ...
                <td width=45% class="bold" valign="top">Student No:</td>

                <td width=55%><?=$row['student_number']?></td>
  ...
  <tr>
      ...
      <tr>
        ...
        <?php
			$grade_yr = explode('-',$row['grade_school_years']);
			$grade_yr1 = explode('/',$grade_yr[0]);
			$grade_yr2 = explode('/',$grade_yr[1]);
			
			$high_yr = explode('-',$row['high_school_years']);
			$high_yr1 = explode('/',$high_yr[0]);
			$high_yr2 = explode('/',$high_yr[1]);
			
			$college_yr = explode('-',$row['college_school_years']);
			$college_yr1 = explode('/',$college_yr[0]);
			$college_yr2 = explode('/',$college_yr[1]);
		?>
      ...
      <tr>
        ...
        <td><?=getMonthName($grade_yr1[0]).' '.$grade_yr1[1].' - '.getMonthName($grade_yr2[0]).' '.$grade_yr2[1]?>
      ...
      <tr>
        ...
        <td><?=getMonthName($high_yr1[0]).' '.$high_yr1[1].' - '.getMonthName($high_yr2[0]).' '.$high_yr2[1]?>
      ...
      <tr>
        ...
        <td><?=getMonthName($college_yr1[0]).' '.$college_yr1[1].' - '.getMonthName($college_yr2[0]).' '.$college_yr2[1]?>
    ...
    <td valign="top"><table width="100%">
      ...
      <tr>
        ...
        <td class="bold" valign="top">Scholarship:</td>

        <td><?=$row['scholarship'].'('.$row['scholarship_type'].')'?></td>
