...
<table width="100%">
  <tr>
    ...
    <?php if($ctr > 0)
		{ ?>
    <a class="viewer_email" href="#" id="email3" title="email3"></a>
    <a class="viewer_pdf" href="#" id="pdf3" title="pdf3"></a>
    <a class="viewer_print" href="#" id="print3" title="print3"></a>
    <?php } ?>    </td>
</tr>
  <tr>
    <td colspan="3" align="center" class="bold">STUDENT AVERAGE | <?=getSchoolTerm($_REQUEST['filter_schoolterm'])?> | SY <?=getSchoolYearStartEndByTerm($_REQUEST['filter_schoolterm'])?></td>
  </tr>
</table>
    ...
    <table class="classic">      
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td><?=round(getStudentAverage($_REQUEST['filter_schoolterm'],$row['id']),2)?></td>
            </tr>
        <?php 
            $x++;    
			$stud_id = $row['id'];      
