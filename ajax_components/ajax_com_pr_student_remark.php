...
function sectionList(pageNum,sched_id)
{
	...
	$('#box_container').load('ajax_components/ajax_com_pr_student_remark_list.php?list_rows=10' + param, null);
}	
...
?>                  
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td class="action">
                    <ul>
                         <li><a class="profile" href="#" title="Student List" returnId="<?=$row['id']?>"></a></li>
                    </ul>
                </td>
            </tr>
        <?php    
