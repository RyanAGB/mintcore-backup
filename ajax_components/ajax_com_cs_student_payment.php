...
$(function(){
	...
	$("a[name='stud_id']").click(function(){
		...
		$('#box_container').load('ajax_components/ajax_com_cs_student_payment_form.php?student_id='+param, null);
		return false;
	});
...
if(count($arr_sql) > 0)
{
	...
	$ctr_reserve = mysql_num_rows($query_pagination); 
...
?>    
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td class="action">
                    <ul>
                        <li><a class="curSub" href="#" name="stud_id" returnId="<?=$row['id']?>" title="Pay"></a></li>
                    </ul>
                </td>
            </tr>
        <?php           
