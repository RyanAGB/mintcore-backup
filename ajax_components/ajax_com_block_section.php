...
$(function(){
	...
	$('.curSub').click(function(){
		...
		$('#dialog').load('viewer/viewer_com_curriculum_subject.php?id='+id, null);
...
$(document).ready(function(){  
	...
	$('.period').click(function(){
			...
			$('#courseID').val($(this).attr("returnCourseID"));

			$('#bid').val($(this).attr("returnBlockID"));
...
$(document).ready(function(){  
	...
	$sql_pagination = "SELECT block.* 

					FROM tbl_block_section block,
					...
					AND block.term_id = term.id

					AND year.id = term.school_year_id
...
?>                  
        ...
        <table class="listview">      
          ...
          <tr>
            ...
            <th class="col_100"><a href="#" class="sortBy" returnFilter="block_name">Block Name</a></th>
        ...
        ?>
            ...
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td><a href="javascript:doTheAction ('edit', 'edit', 'id_<?=$row['id']?>');" class="edtlnk" val="<?=$row["id"]?>"><?=$row["block_name"]?></a></td>
                ...
                <td class="action">
                     ...
                     <ul>
					    ...
					    <li><a class="period" href="#" returnBlockID ="<?=$row['id']?>" returnTermId="<?=$row['term_id']?>" returnCourseID="<?=$row["course_id"]?>" title="click to manage block subject"></a></li>
