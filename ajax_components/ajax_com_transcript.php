...
$(function(){
	...
	$('.schedule').click(function(){
		...
		$('#dialog').load('viewer/viewer_com_transcript.php?id='+param+'&comp='+param2, null);
		$('#dialog').dialog('open');
		return false;
	});
	...
	if($row_ctr>0)
	{
        ...
        <table class="listview">      
          <tr>
              ...
              <th class="col_50">View Transcript</th>
          </tr>
        <?php
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td class="action">
                    <ul>
	                    <li><a class="schedule" href="#" title="View Transcript" returnId="<?=$row['id']?>" returnComp="<?=$_REQUEST['comp']?>"></a></li>
...
?>
<!-- LIST LOOK UP-->
<div id="dialog" title="Student Transcript">
    Loading...
</div><!-- #dialog -->
