...
<?php
	...
	if(isset($fieldName) || $fieldName != '' )
	{
		...
		{
			$sqlOrderBy = " ORDER BY  department.$fieldName ". $_REQUEST['orderBy'] ." , emp.lastname ASC";
		}
		else
		{
	...
	if($row_ctr>0)
	{
        ...
        <table class="listview">      
          <tr>
              ...
              <th class="col_150"><a href="#" class="sortBy" returnFilter="department_name">Department</th>
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td class="action">
                    <ul>
	                    <li><a class="availability" href="#" name="stud_id"  title="Availability" returnId="<?=$row['id']?>"></a></li>
                    </ul>
                </td>
            </tr>
        <?php
