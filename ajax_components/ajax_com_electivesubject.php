...
*  ############################################################ */
	...
	$sql_pagination = "SELECT a.id, s.subject_code, b.curriculum_name,
			s.subject_name, b.curriculum_name FROM tbl_electivesubject AS a,
			 tbl_curriculum AS b, tbl_subject AS s WHERE
			 b.id = a.curriculum_id AND a.subject_id = s.id
						" .$sqlcondition ;
	...
	if($row_ctr>0)
	{
		...
		$max = 'limit ' .$pagenum .',' .$page_rows; 	
			...
			$sql = "SELECT a.id, s.subject_code, b.curriculum_name,
			s.subject_name, b.curriculum_name FROM tbl_electivesubject AS a,
			 tbl_curriculum AS b, tbl_subject AS s WHERE
			 b.id = a.curriculum_id AND a.subject_id = s.id
...
?>                  
        ...
        <table class="listview">      
          <tr>
              ...
              <th class="col_150"><a href="#list" onclick="sortList('building_code');">Curriculum</a></th>
               <th class="col_150"><a href="#list" onclick="sortList('building_name');">Subject Code</a></th>
               <th class="col_250"><a href="#list" onclick="sortList('building_name');">Title</a></th>
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td><a href="javascript:doTheAction ('edit', 'edit', 'id_<?=$row['id']?>');" class="edtlnk" val="<?=$row["id"]?>"><?=$row["curriculum_name"]?></a></td> 
