...
?>                  
        ...
        <table class="listview">      
          <tr>
              <th class="col_20">&nbsp;</th>
            <th class="col_150"><a href="#" class="sortBy" returnFilter="template_name">Template Name</a></th>
              <th class="col_100"><a href="#" class="sortBy" returnFilter="section_no">Section No.</a></th>
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td><a href="javascript:doTheAction ('edit', 'edit', 'id_<?=$row['id']?>');" class="edtlnk" val="<?=$row["id"]?>"><?=$row["template_name"]?></a></td>
                <td><?=$row['section_no']?></td> 
                <td class="action">
                    <ul>
                    	 <li><a class="period" href="#" returnID ="<?=$row['id']?>" title="click to manage template"></a></li>
