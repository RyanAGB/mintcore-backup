...
<?php
	...
	$sql_pagination = "SELECT * FROM tbl_grade_conversion WHERE is_current = 'Y'
						" .$sqlcondition ;
	...
	if($row_ctr>0)
	{
		...
		$sql = "SELECT * FROM tbl_grade_conversion WHERE is_current = 'Y'
...
?>                  
        ...
        <table class="listview">      
          <tr>
              <th class="col_20">&nbsp;</th>
            <th class="col_150"><a href="#" class="sortBy" returnFilter="floor_grade">Floor Grade</a></th>
              <th class="col_350"><a href="#" class="sortBy" returnFilter="ceiling_grade">Ceiling Grade</a></th>
			  <th class="col_350"><a href="#" class="sortBy" returnFilter="grade_code">Grade Code</a></th>
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td><a href="javascript:doTheAction ('edit', 'edit', 'id_<?=$row['id']?>');" class="edtlnk" val="<?=$row["id"]?>"><?=$row["floor_grade"]?></a></td> 
                <td><?=$row["ceiling_grade"]?></td>
