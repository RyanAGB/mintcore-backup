...
/*$(function(){
	...
	$('.schedule').click(function(){
		...
		$('#dialog').load('viewer/viewer_com_student_financial.php?student_id='+param+'&comp='+param2, null);
		$('#dialog').dialog('open');
		return false;
	});
...
$(document).ready(function(){  
	...
	$('.schedule').click(function() {
			var w=window.open ("pdf_reports/rep108.php?id="+$(this).attr("returnId")+"&trm="+$('#filter_schoolterm').val()+"&met=assessment"); 
			return false;
		});
	...
	if($row_ctr>0)
	{
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td class="action">
                    <ul>
	                    <li><a class="schedule" href="#" title="View Financial Record" returnId="<?=$row['id']?>" returnComp="<?=$_REQUEST['comp']?>"></a></li>
                    </ul>
                </td>
            </tr>
        <?php   
...
?>
<!-- LIST LOOK UP
<div id="dialog" title="Student Financial Record">
    Loading...
</div> #dialog -->
