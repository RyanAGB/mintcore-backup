...
$(function(){
	...
	$('.profile').click(function(){
		...
		$('#dialog').load('viewer/view_com_employee_profile.php?id='+param+'&comp='+param2, null);
		$('#dialog').dialog('open');
		return false;
	});
...
<?php
	...
	if($row_ctr>0)
	{
        ...
        <table class="listview">      
          <tr>
              <th class="col_100"><a href="#" class="sortBy" returnFilter="emp_id_number">Professor Code</a></th>
