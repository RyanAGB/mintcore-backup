...
function sectionList(pageNum,sched_id)
{
	...
	$('#box_container').load('ajax_components/ajax_com_pr_school_calendar_list.php?list_rows=10' + param, null);
}	
...
$(function(){
	...
	$('.add').click(function(){
		eventList('add','add',$(this).attr('returnSchedId'));
	});


});	

function eventList(formAction, formView, schedule_id)
{
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td class="action">
                    <ul>
                    	<!--
                         <li><a class="add" href="javascript:changeActionAdd ('add', 'add', 'sched_id<?=$row['id']?>');" title="Add Events" ></a></li>
                         -->
                         <li><a class="add" href="#" title="Add Event" returnSchedId="<?=$row['id']?>"></a></li>
                         <li><a class="profile" href="#" title="Event List" returnId="<?=$row['id']?>"></a></li>
