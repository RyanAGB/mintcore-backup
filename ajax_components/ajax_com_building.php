...
?>                  
        ...
        <table class="listview">      
          <tr>
              <th class="col_20">&nbsp;</th>
            <th class="col_150"><a href="#" class="sortBy" returnFilter="building_code">Building Code</a></th>
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td><?php 
					...
					{
					?>
                    <a href="javascript:doTheAction ('edit', 'edit', 'id_<?=$row['id']?>');" class="edtlnk" val="<?=$row["id"]?>"><?=$row["building_code"]?></a>
                    <?php
                    }
                    else
                    {
                    echo $row["building_code"];
                    }
                    ?></td>
