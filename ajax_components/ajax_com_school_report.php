...
<?php
	...
	$sql_pagination = "SELECT * FROM tbl_school_report
						" .$sqlcondition ;
	...
	if($row_ctr>0)
	{
		...
		$sql = "SELECT * FROM tbl_school_report
...
?>                  
        ...
        <table class="listview">      
          <tr>
              <th class="col_20">&nbsp;</th>
            <th class="col_150"><a href="#" class="sortBy" returnFilter="building_code">Title</a></th>
              <th class="col_350"><a href="#" class="sortBy" returnFilter="building_name">Classification</a></th>
              <th class="col_150 right">Action</th>
          </tr>
        <?php
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td><?php 
					...
					{
					?>
                    <a href="javascript:doTheAction ('edit', 'edit', 'id_<?=$row['id']?>');" class="edtlnk" val="<?=$row["id"]?>"><?=$row["report_name"]?></a>
                    <?php
                    }
                    else
                    {
