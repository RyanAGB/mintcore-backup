...
<?php
	...
	$sql_pagination = "SELECT * FROM tbl_discount WHERE 1 = 1 
						" .$sqlcondition ;
	...
	if($row_ctr>0)
	{
		...
		$sql = "SELECT * FROM tbl_discount WHERE 1 = 1 
...
?>                  
        ...
        <table class="listview">      
          <tr>
              <th class="col_20">&nbsp;</th>
            <th class="col_150"><a href="#" class="sortBy" returnFilter="name">Name</a></th>
              <th class="col_150"><a href="#" class="sortBy" returnFilter="value">Value</a></th>
              <th class="col_350">School Year</th>
