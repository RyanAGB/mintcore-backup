...
<?php
	...
	if($row_ctr>0)
	{
        ...
        <table class="listview">      
          <tr>
              <th class="col_100"><a href="#" class="sortBy" returnFilter="student_number">Student Number</th>
              <th class="col_150"><a href="#" class="sortBy" returnFilter="lastname">Student Name</th>
              <th class="col_200"><a href="#" class="sortBy" returnFilter="course_name">Course</th>
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                ...
                <td><?=getStudentCourseName($row["id"])?></td>
                <td class="action">
                    <ul>
                    	
                        <li><a class="edit" href="#" returnID="<?=$row['id']?>" subjectreturnID="<?=$row['subject_id']?>" title="Add Remarks"></a></li>
                       
                        <li><a class="profile" href="#" returnId="<?=$row['id']?>" title="View Profile" returnComp="<?=$_REQUEST['comp']?>"></a></li>       
                    </ul>
                </td>
            </tr>
        <?php           
