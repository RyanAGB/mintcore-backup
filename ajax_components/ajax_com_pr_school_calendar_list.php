...
<?php
	...
	$sql_pagination = "SELECT * FROM tbl_school_calendar WHERE schedule_id =".$sched_id 
						 .$sqlcondition ;
	...
	if($row_ctr>0)
	{
		...
		$sql = "SELECT * FROM tbl_school_calendar WHERE schedule_id =".$sched_id
...
?>                  
        ...
        <table class="listview">      
          <tr>
              <th class="col_20">&nbsp;</th>
            <th class="col_300"><a href="#" class="sortBy" returnFilter="title">Title</a></th>
              <th class="col_150"><a href="#" class="sortBy" returnFilter="date_from">Date (from - to)</a></th>
