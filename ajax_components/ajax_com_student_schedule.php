...
$(function(){
	...
	$('.schedule').click(function(){
		...
		$('#dialog').load('viewer/viewer_com_student_schedule.php?id='+param+'&comp='+param2, null);
		$('#dialog').dialog('open');
		return false;
	});
	...
	if($row_ctr>0)
	{
        ...
        <table class="listview">      
          <tr>
              ...
              <th class="col_50">View Schedule</th>
          </tr>
        <?php
...
?>
<!-- LIST LOOK UP-->
<div id="dialog" title="Student Schedule Profile">
    Loading...
</div><!-- #dialog -->
