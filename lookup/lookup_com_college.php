	...
	function updateList()
{
		...
		$('#dialog').load('lookup/lookup_com_college.php?listrow=10'+ param, null);
}
</script>
...
<div id="lookup_content">
    ...
    <table class="fieldsetList">      
        <tr>
            ...
            <th class="col1_350"><a href="#">Professor Id</a></th>  
        ...
        ?>
            <tr class="<?=($x%2==0)?"":"highlight";?>">
                <td><a href="#" name="id" id="id_<?=$row['employee_id']?>" class="selector" returnId="<?=$row['id']?>" returnTxt="<?=$row['lastname'].', '.$row['firstname'].' '.$row['middlename']?>">Select</a></td>
