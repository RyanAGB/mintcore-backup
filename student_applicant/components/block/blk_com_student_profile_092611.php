...
<div class="table">
  ...
  <table border="1" cellspacing="0" cellpadding="0" class="tableProperties">
    ...
    <tr>
      ...
      <td><select name="term_id" id="term_id" class="short required" title="school year field is required">
          <option value="" selected="selected">Select</option>
          <?=generateSchoolTermsApplicant($term_id)?>
        </select>
          <label></label></td>
      <td><label>* Admission As</label>
    ...
    <tr>
      ...
      <td><select name="course_id" id="course_id"  class="short required" title="course field is required">
          <option value="" selected="selected">Select</option>
    ...
    <tr>
      ...
      <td colspan="2"><select name="exam_date" id="exam_date"  class="short required" title="examination date field is required">
          <option value="" selected="selected">Select</option>
