	...
	{	
		...
		//alert(val);
			...
			$.ajax({
					type: "POST",
					data: "val=" + val,
					url: "ajax_components/ajax_com_search_all.php",
...
<span style="float:right">SEARCH &nbsp;<input class="txt_150" name="search_all" id="search_all" onkeypress="search_all(this.value);" /></span>
